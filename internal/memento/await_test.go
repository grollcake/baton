...
func TestAwaitReturnsWhenArtifactCompletes(t *testing.T) {
	...
	path := ".memento/runs/20260711-1000-await-RUN-01.md"
...
func TestAwaitTimesOutAndRejectsBadArguments(t *testing.T) {
	...
	path := ".memento/runs/20260711-1000-await-PLAN.md"
	...
	for _, args := range [][]string{
		{"await"},
		{"await", eventPlanned},
		{"await", eventClose, ".memento/runs/x-CLOSE.md"},
		{"await", eventRequest, path},
		{"await", eventPlanned, ".memento/runs/x-RUN-01.md"},
